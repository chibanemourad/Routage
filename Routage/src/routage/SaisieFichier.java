...
public class SaisieFichier extends JFrame {
	...
	public JButton home;// Bouton permettant de revenir à la fenetre "JFrame" d'acceuil	
	...
	public SaisieFichier(){
		...
		home=new JButton("Retour à la fenetre d'acceuil",new ImageIcon("./doc/image/back.png"));
